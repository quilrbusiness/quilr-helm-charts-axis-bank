...
ALTER TABLE quilr_compliance_events ADD COLUMN IF NOT EXISTS environment LowCardinality(String);
ALTER TABLE quilr_compliance_events ADD COLUMN IF NOT EXISTS publisher LowCardinality(String);
